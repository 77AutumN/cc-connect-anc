...
type ImageAttachment struct {
	...
	// PromptMarker preserves the position of an image among rich-text parts.
	// It is generated by the transport, never interpreted as a user instruction.
	PromptMarker string
	// ReceiveError preserves batch failure through quoted/buffered messages.
	ReceiveError MsgKey
}
