...
func ValidateActionHosts(host ActionHost) error {
	...
	for _, command := range []string{"open", "customer", "customers", "stage", "result", "assignee", "stage-customer-create", "stage-customer-update", "case-list", "case-read", "case-update", "case-member-add"} {
